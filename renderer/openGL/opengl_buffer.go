...
func CreateGLVertexBuffer(vertices []float32, unitSize int, count int, hint DrawHint) (*GLVertexBuffer, error){
	vb := &GLVertexBuffer{
		Count: count,
	}
...
func CreateGLIndexBuffer(indices []int32, count int, hint DrawHint) (*GLIndexBuffer, error){
	ib := &GLIndexBuffer{
		Count: count,
	}
